...
proc add_burst_splitter { name width awidth burst_count pending_reads } {
...
proc compose {} {
  ...
  if { $split_bursts == true } {
    ...
    add_burst_splitter $burst_split_ip_name $width $aggr_awidth $burst_width $pending_reads
    add_interface s avalon slave
    set_interface_property s EXPORT_OF $burst_split_ip_name.slave
    add_connection $burst_split_ip_name.master acl_snoop_adapter_0.s1
  } else {
    add_interface s avalon slave
