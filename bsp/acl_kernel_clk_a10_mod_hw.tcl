...
# module properties
set_module_property NAME {acl_kernel_clk_a10_mod}
set_module_property DISPLAY_NAME {OpenCL A10 Kernel Clock Generator Mod}
...
add_parameter KERNEL_1_TARGET_CLOCK_RATE FLOAT 400.0
set_parameter_property KERNEL_1_TARGET_CLOCK_RATE DEFAULT_VALUE 400.0
set_parameter_property KERNEL_1_TARGET_CLOCK_RATE DISPLAY_NAME "KERNEL_1_TARGET_CLOCK_RATE"
set_parameter_property KERNEL_1_TARGET_CLOCK_RATE AFFECTS_ELABORATION true

add_parameter KERNEL_2_TARGET_CLOCK_RATE FLOAT 400.0
set_parameter_property KERNEL_2_TARGET_CLOCK_RATE DEFAULT_VALUE 400.0
set_parameter_property KERNEL_2_TARGET_CLOCK_RATE DISPLAY_NAME "KERNEL_2_TARGET_CLOCK_RATE"
set_parameter_property KERNEL_2_TARGET_CLOCK_RATE AFFECTS_ELABORATION true

add_parameter KERNEL_3_TARGET_CLOCK_RATE FLOAT 400.0
set_parameter_property KERNEL_3_TARGET_CLOCK_RATE DEFAULT_VALUE 400.0
set_parameter_property KERNEL_3_TARGET_CLOCK_RATE DISPLAY_NAME "KERNEL_3_TARGET_CLOCK_RATE"
set_parameter_property KERNEL_3_TARGET_CLOCK_RATE AFFECTS_ELABORATION true
# | 
# +-----------------------------------
...
proc comp { } {
  ...
  add_instance ctrl altera_avalon_mm_bridge 16.1
  ...
  add_instance kernel_clk clock_source 16.1
  ...
  add_instance kernel_clk2x clock_source 16.1
  ...
  add_instance kernel_clk_1 clock_source 16.1
  set_instance_parameter_value kernel_clk_1 {clockFrequency} {50000000.0}
  set_instance_parameter_value kernel_clk_1 {clockFrequencyKnown} {0}
  set_instance_parameter_value kernel_clk_1 {resetSynchronousEdges} {NONE}

  add_instance kernel_clk2x_1 clock_source 16.1
  set_instance_parameter_value kernel_clk2x_1 {clockFrequency} {100000000.0}
  set_instance_parameter_value kernel_clk2x_1 {clockFrequencyKnown} {0}
  set_instance_parameter_value kernel_clk2x_1 {resetSynchronousEdges} {NONE}

  add_instance kernel_clk_2 clock_source 16.1
  set_instance_parameter_value kernel_clk_2 {clockFrequency} {50000000.0}
  set_instance_parameter_value kernel_clk_2 {clockFrequencyKnown} {0}
  set_instance_parameter_value kernel_clk_2 {resetSynchronousEdges} {NONE}

  add_instance kernel_clk2x_2 clock_source 16.1
  set_instance_parameter_value kernel_clk2x_2 {clockFrequency} {100000000.0}
  set_instance_parameter_value kernel_clk2x_2 {clockFrequencyKnown} {0}
  set_instance_parameter_value kernel_clk2x_2 {resetSynchronousEdges} {NONE}

  add_instance kernel_clk_3 clock_source 16.1
  set_instance_parameter_value kernel_clk_3 {clockFrequency} {50000000.0}
  set_instance_parameter_value kernel_clk_3 {clockFrequencyKnown} {0}
  set_instance_parameter_value kernel_clk_3 {resetSynchronousEdges} {NONE}

  add_instance kernel_clk2x_3 clock_source 16.1
  set_instance_parameter_value kernel_clk2x_3 {clockFrequency} {100000000.0}
  set_instance_parameter_value kernel_clk2x_3 {clockFrequencyKnown} {0}
  set_instance_parameter_value kernel_clk2x_3 {resetSynchronousEdges} {NONE}

  add_instance kernel_pll altera_iopll 17.1
  ...
  # set number of clock to 8
  set_instance_parameter_value kernel_pll {gui_number_of_clocks} {8}
  ...
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency2} {350.0}
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency3} {700.0}
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency4} {350.0}
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency5} {700.0}
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency6} {350.0}
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency7} {700.0}
  ...
  add_instance pll_reconfig altera_pll_reconfig 16.1
  set_instance_parameter_value pll_reconfig {ENABLE_MIF} {0}
  set_instance_parameter_value pll_reconfig {MIF_FILE_NAME} {pll_rom}
  set_instance_parameter_value pll_reconfig {ENABLE_BYTEENABLE} {0}
...
# configure clock domain
  ...
  # original kernel, we don't know what counter is responsible for, then ignore it temp
  ...
  add_connection kernel_pll.outclk2 kernel_clk_1.clk_in clock

  add_connection kernel_pll.outclk3 kernel_clk2x_1.clk_in clock

  # kernel 2

  add_connection kernel_pll.outclk4 kernel_clk_2.clk_in clock

  add_connection kernel_pll.outclk5 kernel_clk2x_2.clk_in clock

  # kernel 3

  add_connection kernel_pll.outclk6 kernel_clk_3.clk_in clock

  add_connection kernel_pll.outclk7 kernel_clk2x_3.clk_in clock
  ...
  add_connection clk.clk_reset kernel_clk_1.clk_in_reset reset

  add_connection clk.clk_reset kernel_clk2x_1.clk_in_reset reset

  add_connection clk.clk_reset kernel_clk_2.clk_in_reset reset

  add_connection clk.clk_reset kernel_clk2x_2.clk_in_reset reset

  add_connection clk.clk_reset kernel_clk_3.clk_in_reset reset

  add_connection clk.clk_reset kernel_clk2x_3.clk_in_reset reset
  ...
  add_interface kernel_clk_1 clock source
  set_interface_property kernel_clk_1 EXPORT_OF kernel_clk_1.clk
  add_interface kernel_clk2x_1 clock source
  set_interface_property kernel_clk2x_1 EXPORT_OF kernel_clk2x_1.clk

  add_interface kernel_clk_2 clock source
  set_interface_property kernel_clk_2 EXPORT_OF kernel_clk_2.clk
  add_interface kernel_clk2x_2 clock source
  set_interface_property kernel_clk2x_2 EXPORT_OF kernel_clk2x_2.clk

  add_interface kernel_clk_3 clock source
  set_interface_property kernel_clk_3 EXPORT_OF kernel_clk_3.clk
  add_interface kernel_clk2x_3 clock source
  set_interface_property kernel_clk2x_3 EXPORT_OF kernel_clk2x_3.clk
  ...
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency2} [get_parameter_value KERNEL_1_TARGET_CLOCK_RATE]
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency3} [expr 2.0 * [get_parameter_value KERNEL_1_TARGET_CLOCK_RATE] ] 

  set_instance_parameter_value kernel_pll {gui_output_clock_frequency4} [get_parameter_value KERNEL_2_TARGET_CLOCK_RATE]
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency5} [expr 2.0 * [get_parameter_value KERNEL_2_TARGET_CLOCK_RATE] ]

  set_instance_parameter_value kernel_pll {gui_output_clock_frequency0} [get_parameter_value KERNEL_3_TARGET_CLOCK_RATE]
  set_instance_parameter_value kernel_pll {gui_output_clock_frequency1} [expr 2.0 * [get_parameter_value KERNEL_3_TARGET_CLOCK_RATE] ] 
}
