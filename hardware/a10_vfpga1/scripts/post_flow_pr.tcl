...
if {[string match $revision_name "base"]} {
  ...
  # qexec "quartus_cdb -t scripts/create_fpga_bin_pr.tcl top.sof top.kernel_1.rbf pr_base.id quartus_version.id"
  # qexec "quartus_cdb -t scripts/create_fpga_bin_pr.tcl top.sof top.kernel_2.rbf pr_base.id quartus_version.id"
  # qexec "quartus_cdb -t scripts/create_fpga_bin_pr.tcl top.sof top.kernel_3.rbf pr_base.id quartus_version.id"
} elseif {[string match $revision_name "flat"]} {
