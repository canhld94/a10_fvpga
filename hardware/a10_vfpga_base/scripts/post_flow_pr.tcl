...
if {[string match $revision_name "base"]} {
  ...
  qexec "quartus_cdb $project_name -c $revision_name --export_block kernel --snapshot synthesized --file dump.qdb"
}
...
if {!$fast_compile} {
  source scripts/pr_checks_a10.tcl
}
# run adjust PLL script 
# source scripts/adjust_plls_a10.tcl
